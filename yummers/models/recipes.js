...
},
{
    ...
    preparation: [
        'Scoop 3 tablespoons of sugar in each llanera or flan molds.',
        'Place the llanera on top of the stove over low heat.',
        'When the sugar starts to liquefy, using tongs, turn the llanera in a circular motion to prevent the sugar from burning and let them caramelize evenly.',
        'Remove from heat once all granules have turned liquid and are light brown. Set aside.',
        'Place the egg yolks in a bowl, and slowly beat them with a fork.',
        'Slowly add the condensed and evaporated milk into the egg while continuously stirring.',
        'Add the vanilla extract and zest of key lime and stir a couple of times more until all is well blended.',
        'Sieve the mixture with a strainer to remove undissolved bits.',
        'Pour the egg-milk mixture into each mold.',
        'Place the filled llanera or mold in a water bath and bake in the oven at 180°C/355°F for 25-30 minutes or until an inserted toothpick comes out clean.',
...
},
{
    ...
    preparation: [
        ...
        'Let the cheesecake sit in the oven in the water bath as it cools down for 1 hour.',
...
},
{
    ...
    preparation: [
        'In a medium bowl, add milk, baking powder, vanilla, mayonnaise and egg yolks. ',
        'Sift in cake flour using a flour sifter or fine mesh strainer (make sure you don\'t skip this!).',
        'Mix with a whisk until batter is smooth and the mixture is a pale yellow.',
        'In the bowl of a stand mixer, add chilled egg whites and sugar.<',
        'Make sure your mixing bowl and whisk attachment are completely clean and dry. If there is any oil, your egg whites won\'t turn into meringue.',
        'Whip on the highest speed your mixer allows, until stiff peaks form. Your meringue should be able to hold its form and if you turn the mixing bowl upside down, the meringue will not slide out.',
        ...
        'Make sure you start your folds from the bottom so that the batter at the bottom of the bowl doesn\'t go unmixed. You need to be gentle when folding. If you mix too hard, the meringue will lose its structure.',
        'Once the meringue has been incorporated, add in another third.',
        'Fold in. And then the final third. At the end, you batter should be very light and airy, with the meringue only just incorporated to the point where there are not visible white streaks.',
        'Add two ring molds to a large skillet. Spray the insides of the ring molds with cooking oil spray.',
        'Bring your skillet to low heat. It may take a test one to figure out where exactly you want your heat setting.',
        'Once the oil and pan are hot, fill each ring mold between 1/2 to 2/3 full with batter, allowing some room for them to rise.',
        'Add 1/2 tbsp of water to each side of the pan (preferably not touching the pancakes).',
        'Close the lid and allow to cook about 3-4 minutes.',
        'Your pancakes are ready to flip when the tops look almost completely cooked and you can move the bottom of the pancakes without batter spilling out.',
        'Use a spatula or turner to flip the pancakes (while still in their molds).',
        'Cover and cook for another 2-3 minutes until pancakes are completely cooked and golden brown on both top and bottom.',
        'Place pancakes onto plate. Gently push out of the molds to remove from molds. Repeat with remaining batter.',
